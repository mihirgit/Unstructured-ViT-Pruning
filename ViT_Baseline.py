...
if __name__=='__main__':
    ...
    parser.add_argument('--bs', default='32')  #default original =64
    ...
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=bs, shuffle=True, num_workers=0) #bs=bs, workers=8
